...
public class apiCategory {
    ...
    @GetMapping("/findId")
    public Page<ProductsVO> products(@RequestParam(name = "numberPage", defaultValue = "1") Integer numberPage,
    ...
    @GetMapping("/filter")
    public ResponseEntity<Page<ProductsVO>> filterProducts(
        ...
        ProductSearchCriteria searchCriteria = ProductSearchCriteria.builder()
                ...
                .vga(vga)
                .build();
        List<ProductsVO> result = (sale.equals("true")) ? productService.getListProductByCodeSale() : this.productService.retrieveProducts(searchCriteria);
        ...
        List<ProductsVO> intersectElements = result.stream()
