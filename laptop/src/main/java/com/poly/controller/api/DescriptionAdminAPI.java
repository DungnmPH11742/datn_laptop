...
public class DescriptionAdminAPI {
    ...
    @GetMapping(value = "/admin/description-product/{idProduct}")
    ...
    @GetMapping(value = "/admin/description-blog/{idBlog}")
    ...
    @GetMapping(value = "/admin/descriptionGetById/{id}")
    ...
    @PostMapping(value = "/admin/description/save")
    ...
    @PutMapping(value = "/admin/description/update/{id}")
    ...
    @DeleteMapping(value = "/admin/description/delete/{id}")
