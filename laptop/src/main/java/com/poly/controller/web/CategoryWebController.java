...
public class CategoryWebController {
    ...
    public String getBrandCate(Model model, @PathVariable("nameBrand") String nameBrand, @RequestParam(value = "brand", defaultValue = "") String brand,
        ...
        return getPageByCateGoryAndBrand(1,nameBrand,brand,model);
    }
    @RequestMapping("/category/page/{pageNumber}/{nameBrand}")
    public String getPageByCateGoryAndBrand(@PathVariable(value = "pageNumber") Integer pageNumber, @PathVariable("nameBrand") String nameBrand,
                      @RequestParam(value = "brand", defaultValue = "") String brand, Model model){
        ...
        Page<Products> page = productService.getListByPageNumber(pageNumber,1,productsListTotal);
