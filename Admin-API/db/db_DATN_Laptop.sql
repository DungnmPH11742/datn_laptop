...
insert into account(full_name, phone, email,password,date_of_birth, verification_code, time_token, actived)
values (N'Hằng','0374656354','user@gmail.com','$2a$12$KCCdTXZKuNEVPW4.lgjYUeK/qo5eUbfQkobauR3Nh4i7d.HLB9.3S','2003-06-02',null,null,1)
/*-----------------------------------------------------------------------------------------------------------------------------------*/
insert into account(full_name, phone, email,password,date_of_birth, verification_code, time_token, actived)
...
create table sale_product(
	...
	promotion_type nvarchar(255) not null,--loại | loại sản phẩm | năm | dịp tết | mới nhập
...
insert into products values
	-- lap top
	('MQD32SA',1 , N'Macbook Air MQD32SA/A i5 5350U','2020-11-05',11, 1, '',19000000,23990000,40,1.35,'1 cái','2021','05-2021','SL001',1),
	('DL3520I5',1 , N'Dell Latitude 3520 Intel (Chính hãng)','2021-01-05',3, 1, '',12000000,15990000 ,80,1.79,'1 cái','2021','06-2021','SL001',1),
	('APH30021',1 , N'Acer Predator Helios 300 2021','2020-12-15', 21, 1, '',29000000,33990000 ,40,2.3,'1 cái','2021','08-2021','SL003',1),
	('DV3400I5',1 , N'Dell Vostro 14 3400 Intel gen 11 (Chính Hãng)','2020-11-05', 9, 1, '' ,15000000,18990000,35,1.64,'1 cái','2021','04-2021','SL003',1),
	('LI314R5',1 , N'Lenovo IdeaPad 3 14 (AMD Ryzen 5000)','2021-05-05', 26, 1, '',10000000,14290000,30,1.41,'1 cái','2021','06-2021','SL001',1),
	('AS514',1 , N'Acer Swift 5 14 (Chính hãng)','2021-05-05', 23, 1, '',22000000,26990000,20,1,'1 cái','2021','10-2021','SL005',1),
	('LYS714ITL05',1 ,N'Laptop Lenovo Yoga Slim 7 14ITL05','2021-07-10', 24, 1, '',2300000,26490000,13,1.36,N'1 cái','2021','05-2021','SL003',1),
	('HPZB15G5',1 ,N'Laptop Workstation HP Zbook 15 G5 3AX12AV','2021-10-15', 36, 1, '',43990000,43990000,10,2.6,N'1 cái','2021','10-2021',null,1),
	('MBPR13MWP52',1 ,N'Apple Macbook Pro 13 Touchbar (MWP52)','2020-10-15',12, 1, '',21600000,23990000,30,1.4,N'1 cái','2020','08-2020',null,1),
	-- PC
	('PCDOAIO7080',1 ,N'PC Dell OptiPlex All in One 7480','2021-09-30', 59, 57, '',29600000,30299000,5,5.94,N'1 cái','2021','05-2021',null,1),
	('PCAPN608250U',1 ,N'PC Mini Asus PN60 i5-8250U','2021-10-15', 73, 57, '',7000000,8349000,5,0.7,N'1 cái','2021','10-2021','SL002',1),
	('PCHP280G3SFF',1 ,N'PC HP 280 G3 SFF','2020-12-27',64, 57, '',8000000,8989000,13,5.94,N'1 cái','2021','08-2020','SL001',1),

	--Màn hình
	('MAVG240YS' ,1 ,N'Màn hình Acer VG240YS','2021-10-16', 82, 76, '',4000000,6259000,15,3.85,'1 cái','2020','2020-05-01','SL001',1),
	('MATGVG249Q',1 , N'Màn hình Asus TUF GAMING VG249Q','2021-09-26', 85,76, '',4500000,6390000,10,5.6,'1 cái','2021','2021-01-01','SL003',1),
	('MDE2020H',1 , N'Màn hình Dell E2020H','2021-04-12',79, 76, '',2399000,4399000,10,2.94,'1 cái','2021', '2021-01-01','SL003',1),
	('MHM24F',1 , N'Màn hình HP M24F','2021-05-15', 90, 76, '',3500000,4849000,5,2.5,'1 cái','2021', '2021-05-01','SL003',1),
	('MHM27FW',1 , N'Màn hình HP M27FW','2020-02-15',90, 76, '',4500000,6059000,10,2.5,'1 cái','2021', '2021-02-02','SL004',1);
/*-----------------------------------------------------------------------------------------------------------------------------------*/
...
Create table order_details(
	...
	quantity int not null,
	status int, -- | -1 Đổi trả | 0 Không có gì | 1 Bảo hành 
)
